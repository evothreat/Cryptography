...
def x_times(a):
    """
    Calculate the product of the polynomial p(x) and x in GF(2^8).
...
def g_mult(a, b):
    """
    Calculate the product of two polynomials in GF(2^8) using the Russian Peasant Multiplication algorithm.
    """
...
def array2matrix(arr):
    """
    Convert a 16-byte array into a 4x4 matrix, following the column-major order
    used in AES-128 (also known as the state matrix).
